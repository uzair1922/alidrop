...
- img
- textbox "Add a product link or image link": https://www.aliexpress.com/item/1234567890.html
- button
- button "Search"
- text: No products found Search for products and add them to your store
- alert:
  - text: Error
  - button
  - text: Not a valid AliExpress Product URL
